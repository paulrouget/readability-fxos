...
(function() {
gNetwork.SHA1 = { b64_hmac_sha1: b64_hmac_sha1 };
      ...
      */
      ...
      ,
          ...
          completeRequest: function completeRequest(message, accessor) {
              ...
              if (map.oauth_verifier == null && accessor.verifier != null) {
      ...
      OAuth.SignatureMethod.registerMethodClass(["HMAC-SHA1", "HMAC-SHA1-Accessor"],
          OAuth.SignatureMethod.makeSubclass(
              function getSignature(baseString) {
                  b64pad = '=';
                  var signature = gNetwork.SHA1.b64_hmac_sha1(this.key, baseString);
                  return signature;
              }
          ));
...
gNetwork.rReq = function(method, action) {
